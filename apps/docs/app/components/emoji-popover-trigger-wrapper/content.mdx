...
See [Deep Dive — `customEmojiOptions`](/deep-dive#customemojioptions).

---

### `navOptions`

See [Deep Dive — `navOptions`](/deep-dive#navoptions).

---

### `gridOptions`

See [Deep Dive — `gridOptions`](/deep-dive#gridoptions).
...
- 👉 Curious about what’s next? Head over to [Coming Soon Components](/soon/components)
  to get a sneak peek at upcoming features and planned components—you might find exactly what you’ve been waiting for!
