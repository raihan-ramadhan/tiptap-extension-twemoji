...
<Alert variant="default" className="flex gap-2 items-center">
  <BookOpen />
...
<H2
  iconUrl="https://ofqhpepsytodemxfrhrc.supabase.co/storage/v1/object/public/emojis/okabe-1753276382655-793658"
  iconAlt="okabe"
